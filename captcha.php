...
$letAmount = 6;				//Количество символов, которые нужно набрать
$fonLetAmount = 100;		//Количество символов на фоне
...
for($i=0;$i < $fonLetAmount;$i++)			//добавляем на фон буковки
{
	//случайный цвет
...
for($i=0;$i < $letAmount;$i++)		//то же самое для основных букв
{
   ...
   $x = ($i+6)*$fontSize + rand(1,5);		//даем каждому символу случайное смещение
